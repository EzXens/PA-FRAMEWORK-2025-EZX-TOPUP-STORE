...
function openWhatsApp() {
    const phone = "6285821968930";
    const message = 
`Halo admin EzX Store

Saya ingin melakukan top up game dan membutuhkan bantuan.
Mohon arahan mengenai proses top up, pilihan produk, serta metode pembayaran yang tersedia.

Jika diperlukan, saya bisa mengirimkan detail ID/Server dan produk yang ingin dibeli setelah admin merespons.

Terima kasih sebelumnya admin`;
...
function openInstagram() {
    const username = "ezx_store_official";
